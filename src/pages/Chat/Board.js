...
<div className="max-w-full my-4">
    <header className="bg-blue-700 rounded text-white flex py-2 px-4 align-center justify-between">
      <span className='align-center mt-2'>HealthX Chat</span>
...
<div className="flex flex-col flex-wrap sm:flex-row ">
    ...
    <div className="w-full">
      ...
      <form id="chat-form" className=' py-4 flex justify-between'>
      <input name="username" id="usertextname" placeholder="..." className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5" required />

        <button className="btn bg-black text-white rounded px-6 mx-4" type="submit"><i className="fas fa-paper-plane"></i> Send</button>
      </form>
  </div>
    </>
  )
